chapter 1:
- django is a web framwork used to make apps in python
...
-- tenplates are how the app looks to the users after processing requests (i.e cart get updated w/ movie after adding to cart)
